...
void main()
{
	...
	for (Element element : elements) {
		...
		coeff.set(coeff.get(node1Num + 1, node1Num + 1) + val, node1Num + 1, node1Num + 1);

		val = multiplier * (deltaX(node3, node1)*deltaX(node3, node1) + deltaY(node3, node1) * deltaY(node3, node1));
		coeff.set(coeff.get(node2Num + 1, node2Num + 1) + val, node2Num + 1, node2Num + 1);

		val = multiplier * (deltaX(node1, node2)*deltaX(node1, node2) + deltaY(node1, node2) * deltaY(node1, node2));
		coeff.set(coeff.get(node3Num + 1, node3Num + 1) + val, node3Num + 1, node3Num + 1);
		...
		coeff.set(coeff.get(node1Num + 1, node2Num + 1) + val, node1Num + 1, node2Num + 1);
		coeff.set(coeff.get(node2Num + 1, node1Num + 1) + val, node2Num + 1, node1Num + 1);

		val = multiplier * (deltaX(node1, node2)*deltaX(node2, node3) + deltaY(node1, node2) * deltaY(node2, node3));
		coeff.set(coeff.get(node1Num + 1, node3Num + 1) + val, node1Num + 1, node3Num + 1);
		coeff.set(coeff.get(node3Num + 1, node1Num + 1) + val, node3Num + 1, node1Num + 1);


		val = multiplier * (deltaX(node1, node2)*deltaX(node3, node1) + deltaY(node1, node2) * deltaY(node3, node1));
		coeff.set(coeff.get(node3Num + 1, node2Num + 1) + val, node3Num + 1, node2Num + 1);
		coeff.set(coeff.get(node2Num + 1, node3Num + 1) + val, node2Num + 1, node3Num + 1);
